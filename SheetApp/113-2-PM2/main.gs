...
/********************************************************************************
 *  å®è¡ã¢ã«ã¦ã³ãã®æå ±ãåå¾ãã¦ ownerCell ã«ç»é²
 */
function getOwnerID() {
...
/********************************************************************************
 *  æå®ãããã¢ã«ã¦ã³ããææãã classroom ã®ä¸è¦§ãåå¾ãã
 */
function getOwnerCourses() {
  ...
  /*** (0) å¦çå¯¾è±¡ã¨ãªãã¢ã«ã¦ã³ããåå¾ãã ***/
  const owner = getOwnerID();
  console.log("Target ID: " + owner);

  // ã¡ã¼ã«ã¢ãã¬ã¹ããã¢ã«ã¦ã³ãã®è­å¥å­ãåå¾ãã
  ...
  /*** (1) æå®ãããã¢ã«ã¦ã³ãã®åå ã¯ã©ã¹ãç¢ºèªãã ***/
...
/********************************************************************************
 *  courseInputCell ã«æå®ãããã³ã¼ã¹ã®å­¦çãè¡¨ç¤º
 */
...
/********************************************************************************
 *  StudentMaster ããã®æå ±ã StudentList ã«è¿½å 
 */
...
/********************************************************************************
 *  æå®ãããã¯ã©ã¹ã§ãåå¥ã®çå¾å®ã«æç¨¿ãä½æãã
 */
